...
namespace Zadanie5.Services
{
    public class WarehouseService : IWarehouseService
    {
        ...
        public async Task<int> AddProduct(ProductWarehouse productWarehouse)
        {
            ...
            try
            {
                cmd.CommandText = "UPDATE [Order] SET FulfieledAt = @CreatedAt WHERE IdOrder = @IdOrder";
                cmd.Parameters.AddWithValue("CreatedAt", productWarehouse.CreatedAt);
                ...
                cmd.Parameters.AddWithValue("IdOrder", idOrder);
                cmd.Parameters.AddWithValue("Amount", productWarehouse.Amount);
                cmd.Parameters.AddWithValue("CretaedAt", productWarehouse.CreatedAt);
            ...
            cmd.Parameters.Clear();
            cmd.CommandText = "SELCET TOP 1 IdProductWarehouse FROm Product_Warehouse ORDER BY IdProductWarehouse DESC";
